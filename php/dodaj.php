<form onsubmit="dodaj_glosowanie(); return false">
    <textarea id="naglowek_input" class="naglowek_input" placeholder="Nagłówek" pattern="[A-Za-z0-9.,?\s]{1,128}" required></textarea>
    <br>
    ...
    <br>
    <div id="opcje_nowa">
        <input class="opcja_input" type="text" placeholder="Opcja" pattern="[A-Za-z0-9.,?\s]{1,48}" required><br>
        <input class="opcja_input" type="text" placeholder="Opcja" pattern="[A-Za-z0-9.,?\s]{0,48}"><br>
        <input class="opcja_input" type="text" placeholder="Opcja" pattern="[A-Za-z0-9.,?\s]{0,48}"><br>
    </div>
