...
function zmien_tryb() {
  if (slider.classList.contains("slider2")) {
    ...
    for (let i = 0; i < procent.length; i++)
      procent[i].classList.remove("procent_dark");
    if (document.getElementById("plus_input") != null)
      document.getElementById("plus_input").classList.remove("plus_input_dark");
    ...
    for (let i = 0; i < procent.length; i++)
      procent[i].classList.add("procent_dark");
    if (document.getElementById("plus_input") != null)
